...
debug: $(iso)
	@qemu-system-x86_64 -serial stdio -enable-kvm -d guest_errors,cpu_reset,int,exec -m 4G -cdrom $(iso)

gdb: $(iso)
	@qemu-system-x86_64 -serial stdio -enable-kvm -S -s -m 4G -cdrom $(iso)
